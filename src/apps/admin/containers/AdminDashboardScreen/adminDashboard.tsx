...
import conferenceRoomIcon from "../../../common/assets/icons/conferenceRoomSvg.svg";
...
import LunchSeat from "../../../common/assets/images/lunch.png";
import HotDesking from "../../../common/assets/images/HotDesking.png";
import SeatSummary from "../../../common/assets/images/SeatSummary.png";
import RoasterReport from "../../../common/assets/images/RoasterReport.png";
...
function CommonRow(props: CommonProps) {
  ...
  return (
    <Card className="admin-status grey-font">
      ...
      <div className={`flex flex-row wrap space-between ${customStyle}`}>
        ...
        {typeof head4 !== 'undefined' && head4?.length > 0 && (
          <div className="flex flex-column">
        ...
        {typeof head5 !== "undefined" && head5?.length > 0 && (
          <div className="flex flex-column">
...
export default function AdminDashboardScreen(props: Props) {
  ...
  React.useEffect(() => {
    dispatch(
      CensusActions.censusRequest({
        dynamicQueryParams: [{ user_view: "Admin" }],
      })
    );
  }, []);
        ...
        <div className="left-container">
          ...
          >
            ...
            <div className="flex flex-row wrap space-between">
              ...
              <CommonRow
                ...
                val4={censusData?.buffer_allocations}
                head4={BUFFER_ALLOCATIONS}
                val5={censusData?.conference_room_bookings}
                head5={CONFERENCE_BOOKING}
          ...
          <div className="flex flex-row wrap space-between">
            ...
            <CommonCards
              ...
              border="orange-border"
              img={expired}
              path={EXPIRED_PASSES_DETAILS("admin")}
              handleRedirection={handleRedirection}
            />
            <CommonCards
            ...
            <CommonCards
              ...
              border="blue-border"
              img={defective}
              path={SAFETY_BREACHES_DETAILS("admin")}
              handleRedirection={handleRedirection}
            />
          </div>
        </div>
